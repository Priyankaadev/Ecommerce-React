    ...
    return (
        <div className="product-list-sidebar d-flex flex-column">
            ...
            <div id="categoryList">
                ...
                <a onClick={()=>handleCategoryNavigation(category)} 
                    key={category}
            ...
            <div className="price-filter">
                    ...
                    <div className="form-group">
                        <select name="minPrice" className="form-select" id="minPrice">
                            {minPriceOptions.map(optionValue =>
                                <option key={optionValue} value={optionValue}>{optionValue}
                                </option>)}
                        </select>
                    </div>
                    <div className="form-group">
                ...
                <div className="price-filter-title d-flex ">
            ...
            <button className="btn btn-danger clear-filter" id="clear">Clear Filter</button>
        </div>
    )
}
